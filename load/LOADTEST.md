...
Из результатов оптимизации видно, что за счет введения кэша в DAO мы получили прирост в производительности и в количестве обрабатываемых запросов. Также уменьшена задержка.
Особенно преимущество кэша видно в Get с повторами.
